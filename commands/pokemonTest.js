...
module.exports = {
	...
	if (!message.content.toLowerCase().startsWith(prefix + "ptest")) return;
  ...
  if (message.content.toLowerCase().startsWith(prefix + "ptest")) {   
...
//Sv2 Special Pokemon, type 1 is a vowel & has a type 2
     ...
     message.channel.send({embed: {
            ...
            image: {
               ...
               .replace(/\">/g ,"")
               .replace(/<\//g ,"")
               .replace(/darmanitan-galarian/g ,"darmanitan-galarian-zen")
...
//Sv1 Special Pokemon, type 1 is a vowel & does not have a type 2
     ...
     message.channel.send({embed: {
            ...
            image: {
               ...
               .replace(/\">/g ,"")
               .replace(/<\//g ,"")
               .replace(/darmanitan-galarian/g ,"darmanitan-galarian-standard")},
